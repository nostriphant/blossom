...
describe("OPTIONS /media", function() {
    it('For preflight (OPTIONS) requests, servers MUST also set, at minimum, the Access-Control-Allow-Headers: Authorization, * and Access-Control-Allow-Methods: PUT headers.', function () {
        ...
        list($protocol, $status, $headers, $body) = FeatureCase::request('OPTIONS', '/media');
...
it('The PUT /media endpoint MUST accept binary data in the body of the request', function (string $contents, string $hash) {
    ...
    list($protocol, $status, $headers, $body) = FeatureCase::request('PUT', '/media', upload_resource: tmpfile(), authorization:['t' => 'upload', 'x' => $hash, 'key' => '6eeb5ad99e47115467d096e07c1c9b8b41768ab53465703f78017204adc5b0cc']);
    ...
    list($protocol, $status, $headers, $body) = FeatureCase::request('PUT', '/media', upload_resource: $resource, authorization:['t' => 'upload', 'x' => $hash]);
...
it('The PUT /media endpoint MUST check content-length when existing', function () {
    ...
    list($protocol, $status, $headers, $body) = FeatureCase::request('PUT', '/media', upload_resource: $resource, authorization:['t' => 'upload', 'x' => $hash], headers:[
